...
public class ZookeeperProcessListen {
    ...
    */
    ...
    private LpJedisClusterYamlBean clusterYamlBean;
    ...
    public LpJedisClusterYamlBean getClusterYamlBean() {
		return clusterYamlBean;
	}

	public void setClusterYamlBean(LpJedisClusterYamlBean clusterYamlBean) {
		this.clusterYamlBean = clusterYamlBean;
	}
