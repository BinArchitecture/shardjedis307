...
public interface Commands {
  ...
  public void xpush(final String key, final String... strings);
  
  public void xreset(final String key, final String value);
  
  public void smembersmulti(final String ... keys);
  
  public void zoff(final String key, final double score, final String member);
  
  public void zoff(final String key, final Map<String, Double> scoreMembers);
  
  public void zreset(final String key, final String value);
  
  public void hgetallmulti(final String ... keys);
