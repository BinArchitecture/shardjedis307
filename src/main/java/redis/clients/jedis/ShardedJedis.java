...
public class ShardedJedis extends BinaryShardedJedis implements JedisCommands, Closeable {
  ...
  @Override
  public Long zoff(String key, double score, String member) {
    Jedis j = getShard(key);
    return j.zoff(key, score, member);
  }

  @Override
  public Long zoff(String key, Map<String, Double> scoreMembers) {
    Jedis j = getShard(key);
    return j.zoff(key, scoreMembers);
  }
}
