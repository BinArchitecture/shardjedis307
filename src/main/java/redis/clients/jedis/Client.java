...
public class Client extends BinaryClient implements Commands {
  ...
  @Override
  public void xpush(final String key, final String... string) {
    rpush(SafeEncoder.encode(key), SafeEncoder.encodeMany(string));
  }
  
  @Override
  public void xreset(String key, String value) {
	  xreset(SafeEncoder.encode(key), SafeEncoder.encode(value));
  }
  
  @Override
  public void smembersmulti(String... keys) {
	  smembersmulti(SafeEncoder.encodeMany(keys));
  }
  
  @Override
  public void zoff(final String key, final double score, final String member) {
    zoff(SafeEncoder.encode(key), score, SafeEncoder.encode(member));
  }
  
  @Override
  public void zoff(String key, Map<String, Double> scoreMembers) {
    ...
    zoffBinary(SafeEncoder.encode(key), binaryScoreMembers);
  }
  
  @Override
  public void zreset(String key, String value) {
	  zreset(SafeEncoder.encode(key), SafeEncoder.encode(value));
  }
  
  @Override
  public void hgetallmulti(String... keys) {
	  hgetallmulti(SafeEncoder.encodeMany(keys));
  }
