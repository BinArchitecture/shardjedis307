...
public interface MultiKeyCommands {
  ...
  Long xpush(final String key, final String... keys);
  
  Long xreset(final String key, final String value);
  
  Map<String,Set<String>> smembersmulti(final String... keys);
  
  Long zreset(final String key, final String value);
  
  Map<String, Map<String, String>> hgetallmulti(final String... keys);
}
