...
public class Connection implements Closeable {
  ...
  public Map<String,Set<String>> getMultiBulkFuckReply() {
	  return BuilderFactory.FUCKSTRING_LIST.build(getBinaryMultiBulkReply());
  }
  ...
  @SuppressWarnings("unchecked")
  public List<Object> getMultiObject(final int count) {
  	  flush();
  	  Object o=null;
  	  for (int i = 0; i < count; i++) {
  		  try {
  			 o=readProtocolWithCheckingBroken();
  			  if(i==count-1){
